                                    ...
                                    <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                        <div className="course-item bg-light">
                                            <div className="position-relative overflow-hidden">
                                                {/* <img className="img-fluid" src={value.ItemImg} alt /> */}
                                            ...
                                            <div className="text-center p-4 pb-0">
                                                <h3 className="mb-0 mt-3">{value.CourseName}</h3>
                                                <h3 className="mb-0 mt-3">{value.CoursePrice}</h3>
                                                ...
                                                <h5 className="p-5"> Web Design &amp; Development Course for Beginners</h5>
                                            </div>
