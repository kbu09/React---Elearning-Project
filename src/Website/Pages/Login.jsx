                ...
                <div className="container p-5" style={{ backgroundColor: 'rgb(240, 241, 237)', opacity: '0.9', width: 600, marginTop: 250 }}>
                    ...
                    <form action="/action_page.php" method="post" onSubmit={submitHandel}>
                        <div className="mb-3 mt-3">
                            ...
                            <input type="email" onChange={onChangehandel} value={formvalue.email} className="form-control mt-3" placeholder="Enter email" name="email" />
                        </div>
                        <div className="mb-3">
                        ...
                        <p> Create New Account, <NavLink to="/signup"> Click Here </NavLink></p>
